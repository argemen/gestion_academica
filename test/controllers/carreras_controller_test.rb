...
class CarrerasControllerTest < ActionController::TestCase
  ...
  test "should create carrera" do
    assert_difference('Carrera.count') do
      post :create, carrera: { area_academica: @carrera.area_academica, nombre: @carrera.nombre, telefono: @carrera.telefono }
    end
  ...
  test "should update carrera" do
    patch :update, id: @carrera, carrera: { area_academica: @carrera.area_academica, nombre: @carrera.nombre, telefono: @carrera.telefono }
    assert_redirected_to carrera_path(assigns(:carrera))
  end
